#!/usr/bin/env python3
"""
Healthcare Coverage Dose-Response Sweep.

Validates 007 using run_absdes_simulation() from the production backend.
...
Outputs saved to 007_coverage_sweep/results/ directory.

Usage (from project root):
    python 007_coverage_sweep/coverage_sweep.py
"""
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  Coverage Sweep Validation")
