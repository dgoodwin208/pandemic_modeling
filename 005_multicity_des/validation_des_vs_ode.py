#!/usr/bin/env python3
"""
Nigeria Country-Scale Validation.

Validates 005 using run_absdes_simulation() from the production backend.
...
Outputs saved to 005_multicity_des/results/ directory.

Usage (from project root):
    python 005_multicity_des/validation_des_vs_ode.py
"""
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  Nigeria Country-Scale Validation")
