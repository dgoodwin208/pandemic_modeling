#!/usr/bin/env python3
"""
Continental Africa Validation.

Validates 006 using run_absdes_simulation() from the production backend.
...
Outputs saved to 006_continental_africa/results/ directory.

Usage (from project root):
    python 006_continental_africa/africa_des_sim.py
"""
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  Continental Africa Validation")
